    ...
    <div className="max-w-lg mx-auto px-4 py-8">
      ...
      <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        <section>
          ...
          <p>Ao utilizar a plataforma Nó Tarbadja, o utilizador aceita estes termos de uso na sua totalidade. Se não concordar com algum dos termos, deve cessar a utilização da plataforma.</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">2. Descrição do Serviço</h2>
          <p>O Nó Tarbadja é uma plataforma que conecta clientes com prestadores de serviços na Guiné-Bissau. Não somos parte em nenhuma transacção entre clientes e prestadores, servindo apenas como intermediário digital.</p>
        </section>
        ...
        <section>
          ...
          <p>O Nó Tarbadja não se responsabiliza pela qualidade dos serviços prestados, por disputas entre utilizadores, ou por qualquer dano resultante da utilização da plataforma. Os prestadores são profissionais independentes.</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">6. Propriedade Intelectual</h2>
          <p>Todo o conteúdo da plataforma, incluindo design, logótipos e textos, é propriedade do Nó Tarbadja. Os utilizadores mantêm os direitos sobre o conteúdo que publicam.</p>
        </section>
        ...
        <section>
          ...
          <p>Para questões sobre estes termos, contacte-nos em contacto@notarbadja.gw.</p>
        </section>
      </div>
    </div>
  </div>
